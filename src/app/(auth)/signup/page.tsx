...
export default function SignupPage() {
  ...
  const handleNext = async () => {
    const fieldsToValidate: (keyof SignupFormData)[] =
      step === 1 ? ['name', 'email', 'phone', 'password', 'confirmPassword'] : [];
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    router.push('/subscribe');
      ...
      if (error.code === 'auth/email-already-in-use') {
        ...
        description = 'Database permission error. Please contact support.';
      }
      ...
      <Card className="border-4 rounded-[3rem] shadow-3xl overflow-hidden bg-white/80 backdrop-blur-xl">
                    ...
                    <div className="space-y-2 text-left">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          {...register('name')}
                          className="h-14 rounded-2xl border-2 font-black uppercase text-lg shadow-inner focus-visible:ring-primary/20"
                        />
                      </div>
                      {errors.name && (
                    ...
                    <div className="space-y-2 text-left">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-14 pl-12 rounded-2xl border-2 font-black uppercase text-lg tracking-tight shadow-inner focus-visible:ring-primary/20"
                        />
                      </div>
                      {errors.businessName && (
                        <p className="text-[10px] font-bold text-destructive uppercase ml-1">
                            ...
                            <label htmlFor="solo-mode" className="cursor-pointer">
                              ...
                              >
                                <User
                                  className={cn(
                                    'mb-2 h-8 w-8',
                                    field.value === 'solo' ? 'text-primary' : 'text-muted-foreground opacity-40'
                                  )}
                                />
                            ...
                            <label htmlFor="team-mode" className="cursor-pointer">
                              ...
                              >
                                <Users
                                  className={cn(
                                    'mb-2 h-8 w-8',
                                    field.value === 'team' ? 'text-primary' : 'text-muted-foreground opacity-40'
                                  )}
                                />
        ...
        <CardFooter className="p-8 pt-0 flex flex-col gap-4">
          <div className="flex w-full gap-3">
            {step > 1 && (
              <Button
                ...
                onClick={handleBack}
                type="button"
                className="flex-1 h-14 font-black uppercase tracking-widest text-[10px] text-slate-400"
              >
            ...
            {step < 2 ? (
              <Button
                onClick={handleNext}
                className="flex-[2] h-14 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary/20 group transition-all"
              >
          ...
          <p className="text-[10px] text-muted-foreground font-black uppercase tracking-widest">
            Already registered?{' '}
            <Link href="/login" className="text-primary underline decoration-2 underline-offset-4">
              Access Portal
            </Link>
          </p>
        </CardFooter>

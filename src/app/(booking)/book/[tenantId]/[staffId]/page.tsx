        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground max-w-xl">{staffMember.bio || 'A passionate professional dedicated to their craft and clients.'}</p>
           <div className="flex items-center justify-center md:justify-start gap-2 pt-2">
            ...
            {staffMember.facebookUrl && (
                <Button variant="outline" size="icon" asChild>
                    <a href={staffMember.facebookUrl} target="_blank" rel="noopener noreferrer">
                        <Facebook className="h-5 w-5" />
                    </a>
                </Button>
            )}
            {staffMember.twitterUrl && (
                <Button variant="outline" size="icon" asChild>
                    <a href={staffMember.twitterUrl} target="_blank" rel="noopener noreferrer">
                        <Twitter className="h-5 w-5" />
                    </a>
                </Button>
            )}
            {staffMember.tiktokUrl && (
                <Button variant="outline" size="icon" asChild>
                    <a href={staffMember.tiktokUrl} target="_blank" rel="noopener noreferrer">

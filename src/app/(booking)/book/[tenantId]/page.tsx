...
import { Loader, ArrowDown, Users, Sparkles, MapPin, Phone, Instagram, ArrowRight, FileText, Calendar, Star, ChevronRight } from 'lucide-react';
...
const QuoteRequestBanner = ({ tenantId, tenant }: { tenantId: string; tenant: Tenant | null | undefined }) => (
    <motion.section
        initial={{ opacity: 0, y: 24 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: '-80px' }}
        transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
        className="relative overflow-hidden rounded-[3rem] border-2 border-primary/10 bg-gradient-to-br from-primary/5 via-background to-primary/[0.03] p-10 md:p-16"
    >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="shrink-0 flex items-center justify-center">
                <div className="relative w-24 h-24">
                    ...
                    {/* Floating badges */}
                    <div className="absolute -top-3 -right-3 w-8 h-8 rounded-xl bg-white border-2 border-primary/20 shadow-md flex items-center justify-center">
                        <Calendar className="w-4 h-4 text-primary" />
                    </div>
                    <div className="absolute -bottom-3 -left-3 w-8 h-8 rounded-xl bg-white border-2 border-primary/20 shadow-md flex items-center justify-center">
            ...
            <div className="flex-1 text-center md:text-left space-y-4">
                <div className="space-y-1">
                    ...
                    <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tighter text-slate-900 leading-none">
                        Need Something Bigger?
                    </h2>
                </div>
                <p className="text-sm md:text-base font-medium text-muted-foreground leading-relaxed max-w-lg">
                    Planning a wedding, bridal party, corporate event, or photoshoot?
                    Submit a request and we'll build a custom quote tailored to your vision —
                    staffing, timeline, travel, and all.
                </p>

                {/* Feature pills */}
                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    {['Bridal Parties', 'Corporate Events', 'Destination Services', 'Group Bookings', 'Custom Packages'].map(tag => (
                        <span key={tag} className="px-3 py-1.5 rounded-full border-2 border-primary/10 bg-primary/5 text-[10px] font-black uppercase tracking-widest text-primary/70">
                            {tag}
                        </span>
                    ))}
                </div>
            ...
            <div className="shrink-0 flex flex-col gap-3 w-full md:w-auto">
                <Button
                    asChild
                    size="lg"
                    className="h-14 md:h-16 px-8 md:px-10 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary/20 group w-full md:w-auto"
                >
        ...
        >
                ...
                {!entered && (
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Quote request shortcut on splash */}
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
            ...
            <main className={cn(
                ...
                <div className="space-y-32 py-20 px-4 md:px-8 max-w-6xl mx-auto">
                    ...
                    {/* ── Quote Request Banner ── sits right after services ── */}
                    <QuoteRequestBanner tenantId={tenantId} tenant={tenant} />

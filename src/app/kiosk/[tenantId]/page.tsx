    ...
    try {
      ...
      if (apt.clientId) {
        try {
          ...
          const cSnap = await _getDoc(_doc(firestore, 'tenants', tenantId, 'clients', apt.clientId));
          if (cSnap.exists() && isBirthdayToday(cSnap.data().birthday)) {
            setBirthdayName(cSnap.data().name || 'Guest');

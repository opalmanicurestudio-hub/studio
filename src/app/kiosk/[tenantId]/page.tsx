...
export default function WalkInPage() {
  ...
  const studioEventsQ = useMemoFirebase(() => query(collection(firestore, `tenants/${tenantId}/studioEvents`), where('status', '==', 'active')), [firestore, tenantId]);
  ...
  const activeStudioEvent = useMemo(() => {
    ...
    return studioEvents[0]; // query already filters to status==='active'
  }, [studioEvents]);

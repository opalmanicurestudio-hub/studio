    ...
    return (
        <div className="flex-1 relative overflow-auto" ref={scrollContainerRef}>
            <div className="grid grid-cols-[auto,1fr] min-w-max">
                ...
                <div className="sticky top-0 z-20 grid col-start-2 bg-background" style={{ gridTemplateColumns: `repeat(${staff.length}, minmax(${isMobile ? 0 : 250}, 1fr))` }}>
                ...
                {/* Main content grid */}
                <div className="col-start-2 grid relative" style={{ gridTemplateColumns: `repeat(${staff.length}, minmax(${isMobile ? 0 : 250}, 1fr))` }}>
    ...
    <div className="flex h-screen w-full flex-col">
      ...
      <div className="p-4 border-b space-y-4">
        ...
        <div className="flex items-center justify-end gap-2">
            ...
            <Button size="sm" onClick={() => setIsAddEventOpen(true)}>{isMobile ? '+ Event' : <><PlusCircle className="mr-2 h-4 w-4"/>Add Event</>}</Button>
            <Button size="sm" onClick={() => setIsAddAppointmentOpen(true)}>{isMobile ? '+ Appointment' : <><PlusCircle className="mr-2 h-4 w-4"/>Add Appointment</>}</Button>
        </div>
      </div>

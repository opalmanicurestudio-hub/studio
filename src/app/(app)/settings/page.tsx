            ...
            <TabsContent value="builder" className="mt-0 space-y-10 animate-in fade-in duration-500 text-left">
              <Card className="border-2 shadow-sm rounded-[2.5rem] overflow-hidden bg-white">
                <CardHeader className="bg-muted/5 border-b p-6 md:p-8">
                  ...
                  <CardDescription className="text-[10px] font-bold uppercase tracking-widest opacity-60 mt-1">Configure your guest-facing digital presence.</CardDescription>
                </CardHeader>
                <CardContent className="p-6 md:p-8 space-y-10 text-left">
                  ...
                  <div className="space-y-8">
                    <div className="space-y-2">
                      ...
                      <ImageUpload onImageUploaded={(url) => setTenantData(prev => ({ ...prev, bookingPageSettings: { ...prev.bookingPageSettings, logoUrl: url } }))} initialImage={tenantData.bookingPageSettings?.logoUrl} />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Hero Title</Label>
                        <Input value={tenantData.bookingPageSettings?.heroTitle || ''} onChange={e => setTenantData(prev => ({ ...prev, bookingPageSettings: { ...prev.bookingPageSettings, heroTitle: e.target.value } }))} disabled={!isEditing} className="h-12 rounded-xl border-2 font-bold" />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea value={tenantData.bookingPageSettings?.welcomeMessage || ''} onChange={e => setTenantData(prev => ({ ...prev, bookingPageSettings: { ...prev.bookingPageSettings, welcomeMessage: e.target.value } }))} disabled={!isEditing} className="rounded-xl border-2 bg-muted/5 min-h-[100px]" />
                    </div>
                  </div>

...
import {
  ArrowLeft, Clock, Sparkles, Hammer, Users, TrendingUp, MapPin,
  Link as LinkIcon, Target, Briefcase, Calendar as CalendarIcon,
  Scale, Loader, Pencil,
} from 'lucide-react';
      ...
      <CardContent className="p-6 sm:p-8 space-y-10 text-left">
        <div className="space-y-4">
          <h4 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2 opacity-60">
            <Scale className="w-3.5 h-3.5" />Material Components
          </h4>
        ...
        <div className="space-y-4">
          <h4 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2 opacity-60">
            <Clock className="w-3.5 h-3.5" />Fixed Foundation Allocation
          </h4>
          <div className="flex justify-between items-center bg-muted/20 p-5 rounded-[1.5rem] border-2 gap-4">
            <div className="space-y-0.5 text-left">
              ...
              <p className="text-[10px] font-bold text-muted-foreground uppercase">
                {(service.duration || 0) + (service.padBefore || 0) + (service.padAfter || 0)} Min @ ${tmhr.toFixed(2)}/hr
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-10">
          <div className="lg:col-span-2 xl:col-span-3 space-y-10 min-w-0 order-2 lg:order-1">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { label: 'Bookings', icon: CalendarIcon, value: servicePerformance?.totalBookings, highlight: false },
                { label: 'Total Yield', icon: TrendingUp, value: `$${servicePerformance?.totalRevenue.toFixed(0)}`, highlight: false },
                { label: 'Guests', icon: Users, value: servicePerformance?.uniqueClients, highlight: false },
                ...
                <Card className="border-2 shadow-sm rounded-[2rem] overflow-hidden bg-white">
                  <CardHeader className="bg-muted/5 border-b p-6 sm:p-8 pb-4">
                    <CardTitle className="text-[10px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-3">
                      <MapPin className="w-4 h-4 text-primary" />Resource Dependencies
                    </CardTitle>
                  </CardHeader>

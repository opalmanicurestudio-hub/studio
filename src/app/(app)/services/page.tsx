...
```
<changes>
  <description>I've updated the `ServiceCard` component on the main `/services` page to display the pricing tiers (Junior, Senior, Master) for a service directly on the card. This provides a clearer, at-a-glance view of the pricing structure. The price display now uses a DollarSign icon instead of the Landmark icon for better clarity.</description>
  <change>
    <file>src/app/(app)/services/page.tsx</file>
    <content><![CDATA[

...
const BRAND_KITS = [
  { id: 'slate',      label: 'Slate',      accentColor: '#000000', bgColor: '#ffffff', headingFont: 'josefin',    bodyFont: 'inter',       borderRadius: 4,  desc: 'Clean minimal'  },
...
const SECTION_DEFS: Record<SectionType, SectionDef> = {
  ...
  hero: { label: 'Hero', icon: ImageIcon, color: '#534AB7', fields: [
    ...
    { id: 'centered',   label: 'Centered',       preview: '[ bg · headline · cta ]'      },
    { id: 'kinetic',    label: 'Kinetic words',   preview: '[ w·o·r·d · by · word → ]'   },
    { id: 'layers',     label: 'Depth layers',    preview: '[ mouse-reactive parallax ]'  },
    { id: 'filmstrip',  label: 'Filmstrip',       preview: '[ ░▓█ scrolling images █▓░ ]' },
    { id: 'magazine',   label: 'Magazine',        preview: '[ bold text | image ]'        },
    { id: 'split',      label: 'Split',           preview: '[ text | image ]'             },
    { id: 'cinematic',  label: 'Cinematic',       preview: '[ 100vh · bottom text ]'      },
    { id: 'fullbleed',  label: 'Full bleed',      preview: '[ full bg · overlay ]'        },
    { id: 'minimal',    label: 'Minimal',         preview: '[ white · left text ]'        },
  ]},

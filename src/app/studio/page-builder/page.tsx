...
import {
  LayoutNavbar, Image, Award, Scissors, Users, Star,
...
const FieldRenderer = ({ field, value, onChange }: {
  ...
  const inputCls = 'h-10 rounded-xl border-2 text-sm';
...
export default function PageBuilderPage() {
  ...
  // Load existing config from tenant
  useEffect(() => {
        ...
        <div className="flex h-full">
                ...
                <div className="space-y-2">
                  ...
                  {disabledSections.length === 0
                    ...
                    : disabledSections.map(s => (
                      <LibraryItem key={s.id} section={s} onAdd={() => addSection(s.id)} />
                    ))
                  }
                </div>
              )}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {ACCENT_COLORS.map(c => (
                        <button
                          ...
                          className={cn(
                            'w-7 h-7 rounded-full border-4 transition-transform hover:scale-110',
                            style.accentColor === c ? 'border-slate-900 scale-110 shadow-md' : 'border-transparent',
                          )}
                          style={{ background: c }}
                          title={c}
                        />
                      ...
                      {BG_COLORS.map(c => (
                        <button
                          ...
                          className={cn(
                            ...
                            style.bgColor === c.hex ? 'border-primary shadow-md scale-105' : 'border-border',
                          )}
          ...
          <div className="flex-1 h-full flex flex-col overflow-hidden">
            {selectedSection && activePanel === 'sections' ? (
              <>
                <div className="p-6 border-b bg-white flex items-center gap-4 shrink-0">
                  <div
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-6 text-muted-foreground p-8">
                ...
                <div className="text-center space-y-1">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest opacity-50 max-w-xs">
                    Set colors and fonts using the left panel. Changes apply live to your booking page.
                  </p>
                </div>
                <div className="flex flex-col items-center gap-4 mt-2">
                  <div style={{ fontFamily: headingFontDef?.stack, color: style.accentColor, fontSize: '32px', fontWeight: 300 }}>
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-4 text-muted-foreground">
                ...
                <div className="text-center space-y-1">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest opacity-40 max-w-xs">
                    Click any section in the left panel to edit its content and wording
                  </p>
                </div>

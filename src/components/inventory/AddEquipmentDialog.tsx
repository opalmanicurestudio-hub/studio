    ...
    <FormProvider {...methods}>
      <DialogContainer open={open} onOpenChange={handleOpenChange}>
        <DialogContentContainer
          ...
          side="bottom"
        >
            <DialogHeader className={isMobile ? "p-4 border-b shrink-0" : "p-6 pb-4 shrink-0"}>
                <DialogTitle>{title}</DialogTitle>
                <DialogDescription>{description}</DialogDescription>
            </DialogHeader>
            
            <form id={formId} onSubmit={handleSubmit(handleSave)} className="flex-1 min-h-0">
            ...
            <DialogFooter className={isMobile ? "p-4 border-t shrink-0" : "p-6 pt-4 border-t shrink-0"}>

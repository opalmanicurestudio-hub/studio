...
export function InteractiveFrame({ html, title, accent, minHeight = 260, onProblem }: { html: string; title?: string; accent?: string | null; minHeight?: number; onProblem?: (p: string) => void }) {
